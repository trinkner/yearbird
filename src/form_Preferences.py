...
class Ui_frmPreferences(object):
    def setupUi(self, frmPreferences):
        ...
        self.grpEbirdApiKey.setGeometry(QtCore.QRect(10, 170, 811, 90))
        ...
        self.grpPhotoDataFile.setGeometry(QtCore.QRect(10, 270, 811, 127))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, frmPreferences):
        ...
        self.lblEbirdApiKey.setText(_translate("frmPreferences", "Optional. Required for eBird region checklist features. Get a free key at ebird.org/api/keygen."))
