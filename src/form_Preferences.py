...
class Ui_frmPreferences(object):
    def setupUi(self, frmPreferences):
        ...
        self.grpStartupFolder.setStyleSheet("QGroupBox { font-size: 14px; font-weight: bold; } QGroupBox QWidget { font-size: 13px; font-weight: normal; }")
        ...
        self.buttonBox.setGeometry(QtCore.QRect(10, 410, 166, 28))
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Cancel|QtWidgets.QDialogButtonBox.StandardButton.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.grpEbirdApiKey = QtWidgets.QGroupBox(frmPreferences)
        self.grpEbirdApiKey.setGeometry(QtCore.QRect(10, 307, 811, 90))
        self.grpEbirdApiKey.setObjectName("grpEbirdApiKey")
        self.grpEbirdApiKey.setStyleSheet("QGroupBox { font-size: 14px; font-weight: bold; } QGroupBox QWidget { font-size: 13px; font-weight: normal; }")
        ...
        self.verticalLayout_3.addWidget(self.txtEbirdApiKey)
        ...
        self.grpPhotoDataFile.setStyleSheet("QGroupBox { font-size: 14px; font-weight: bold; } QGroupBox QWidget { font-size: 13px; font-weight: normal; }")
